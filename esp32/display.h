...
inline void display_setConnectivity(bool wifiConnected, bool mqttConnected) {
    _displayWifiConnected = wifiConnected;
    _displayMqttConnected = mqttConnected;
}

inline void display_setTimerStatus(int remainSec, int totalSec, int timerState) {
...
inline void display_update(int mode, const char* postureType, bool isAbnormal) {
#if ENABLE_OLED && DISPLAY_U8G2_AVAILABLE
    if (!_displayReady) {
        return;
    }
...
inline void display_showSplash() {
#if ENABLE_OLED && DISPLAY_U8G2_AVAILABLE
    if (!_displayReady) {
        return;
    }
...
inline void display_showMessage(const char* line1, const char* line2 = NULL) {
#if ENABLE_OLED
    if (line1 == NULL) {
        _displayMsg1[0] = '\0';
    } else {
